...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_INT = 3,                        /* INT  */
  YYSYMBOL_JABKE = 4,                      /* JABKE  */
  YYSYMBOL_JABTAK = 5,                     /* JABTAK  */
  YYSYMBOL_LIKHO = 6,                      /* LIKHO  */
  YYSYMBOL_ID = 7,                         /* ID  */
  YYSYMBOL_NUM = 8,                        /* NUM  */
  ...
  YYSYMBOL_loop_stmt = 24,                 /* loop_stmt  */
...
{
  "\"end of file\"", "error", "\"invalid token\"", "INT", "JABKE",
  "JABTAK", "LIKHO", "ID", "NUM", "STRING", "ASSIGN", "PLUS", "SEMICOLON",
  "LPAREN", "RPAREN", "LBRACE", "RBRACE", "$accept", "program",
  "statements", "statement", "declaration", "assignment", "print_stmt",
  "loop_stmt", "expression", "term", YY_NULLPTR
};
...
{
       3,    -5,     0,     8,    -3,    11,     3,    -7,    -7,    -7,
      -7,    -7,    10,     9,    14,     9,    -7,    -7,    -7,    -7,
      -7,     1,    -7,     6,     7,     9,    12,    13,    -7,    -7,
       3,    -7,    -2,    -7
};
...
{
       0,     0,     0,     0,     0,     0,     2,     4,     5,     6,
       7,     8,     0,     0,     0,     0,     1,     3,     9,    15,
      16,     0,    14,     0,     0,     0,     0,     0,    10,    13,
       0,    11,     0,    12
};
...
{
      -7,    -7,    -1,    -6,    -7,    -7,    -7,    -7,    15,    16
};

/* YYDEFGOTO[NTERM-NUM].  */
static const yytype_int8 yydefgoto[] =
{
       0,     5,     6,     7,     8,     9,    10,    11,    21,    22
};
...
{
      17,     1,    12,     2,     3,     4,     1,    15,     2,     3,
       4,    16,    25,    13,    33,    26,    19,    20,    25,    28,
      27,    14,    18,    23,     0,    31,    17,    30,     0,    32,
...
{
       6,     3,     7,     5,     6,     7,     3,    10,     5,     6,
       7,     0,    11,    13,    16,    14,     7,     8,    11,    12,
      14,    13,    12,     9,    -1,    12,    32,    15,    -1,    30,
...
static const yytype_int8 yystos[] =
{
      ...
      23,    24,     7,    13,    13,    10,     0,    20,    12,     7,
       8,    25,    26,     9,    25,    11,    14,    14,    12,    26,
      15,    12,    19,    16
};
...
void yyerror(const char *s)
{
    // Print line number and the error message
